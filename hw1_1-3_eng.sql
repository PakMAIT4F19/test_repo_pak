...
-- this ‘, ‘ causes the problem while reading column (L) in 24478 th row (sql tries to divide 1 column consisted of ‘Ò+ À1-Àêöèè, ïàè è ÄÐ’ on 2 different columns
...
-- c) (K): use formula "\=ËÅÂÑÈÌÂ(K133;1)\", cause real value of 00.01.1900 = 0, but it's a text. OR change it on zero
